...
[![Build Status](https://builds.gbif.org/job/hp-specify/badge/icon)](https://builds.gbif.org/job/hp-specify/lastBuild/console)
...
# GBIF Hosted Portal: specify

This Jekyll website, **[specify (Staging)](https://specify.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
